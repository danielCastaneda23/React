        ...
        <>
            <Card style={{ width: '800px', marginTop: '200px' }}>
                ...
                <Card.Body>
                    ...
                    {stateButton ? <div className="text-center mt-3"><Link to={`/cart`} className="text-white"><Button variant="dark" onClick={() => setCart([...cart, { item: { img: props.information[1], title: props.information[0], price: props.information[2], id: props.information[3] }, quantity: addToCar }])}>TERMINAR COMPRA </Button></Link></div> : null}
                </Card.Body>
            </Card>
